...
function menu.Initialize(menutable)
								...
								if v2.extra ~= nil then
									if v2.extra.type == "keybind" then
										...
										event:connect(function(newval) 
											if pcall(function() return menu:GetVal("Visuals", "Keybinds", "Log Keybinds") end) and menu:GetVal("Visuals", "Keybinds", "Log Keybinds") then 
	...
	function menu:GetVal(tab, groupbox, name, ...)
		...
		local option = menu.options and menu.options[tab] and menu.options[tab][groupbox] and menu.options[tab][groupbox][name]
		if not option then
			return nil
		end
	...
	function menu:SetKey(tab, groupbox, name, val)
		val = val or false
		local root = menu.options and menu.options[tab] and menu.options[tab][groupbox] and menu.options[tab][groupbox][name]
		local option = root and root[5]
		if not option then
			return nil
		end
		if option.toggletype ~= 0 then
